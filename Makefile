...
UI: src/main.c src/core/grid.c src/UI/render.c src/UI/input.c src/UI/ui.c
	$(CC) $(CFLAGS) -o executable/JDLV src/main.c src/core/grid.c src/UI/render.c src/UI/input.c src/UI/ui.c $(LIBS)
